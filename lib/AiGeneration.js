...
function summary(story) {
	const input = `The story so far:\n\n${story}\n\nGenerate a list of 10 bullet points in 2nd person summarizing the story so far:\n\n-`;
